                ...
                <div id="app-update-container" class="card-body font-14">
                    ...
                    <?php
                        ...
                        foreach ($installable_updates as $salt => $version) {
                            ...
                            if ($count > 1) {
                                echo "<p>Click here to Apply the version - <b>$version</b></p>";
                            } else {
                                echo "<p><a class='do-update' data-version='$version' href='#'>Click here to Apply the version - <b>$version</b></a></p>";
                            }
                        ...
                        <div>
                            ...
                            if ($supported_until) {
                                if ($has_support) {
                                    ...
                                    echo "<p>To purchase support, please visit <a href='https://codecanyon.net/item/nexacore-ultimate-project-manager/15455641'>here</a>.</p>";
                                }
                            }
                            ?>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
            ...
            if ($link.length) {
                ...
                appAjaxRequest({
                    ...
                    success: function(response) {
                        if (response.success) {
                            $(".downloading").html("<a class='do-update' data-version='" + version + "' href='#'>Click here to Apply the version - <b>" + version + "</b></a>").removeClass("downloading");
                            startDownload();
                        } else {
        ...
        $('body').on('click', '.do-update', function() {
            ...
            $("#app-update-container").html("<h3><span class='download-loader-lg spinning-btn spinning'></span> Applying version - " + version + ". Please wait... </h3>");
            appAjaxRequest({
                ...
                success: function(response) {
                    ...
                    if (response.response_type === "success") {
                        ...
                        $("#app-update-container").append("<p><a class='do-update' data-acknowledged='1' data-version='" + version + "' href='#'>I understand, apply the version - <b>" + version + "</b></a></p>");
                    } else {
